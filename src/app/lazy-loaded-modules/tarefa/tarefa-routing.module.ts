...
const routes: Routes = [
  ...
  { path: ':id', component: TarefaDetailsComponent, resolve: { t: TarefaResolver } },
  { path: ':id/edit', component: TarefaFormComponent, resolve: { t: TarefaResolver }, canDeactivate: [FormGuard] },
];
